...
'''
This Dictionary lists Enemies/Items and their 'weightings', which is their likeliness to spawn.
The int value is the dungeon floor level where the enemy/item will be added to the spawn pool.
Notice that troll is defined multiple times. This is because every few floors the likelyhood
to spawn trolls goes up.
'''
...
def place_entities(room: RectangularRoom, dungeon: GameMap, floor_number: int,) -> None:
    ...
    for entity in monsters + items:
        ...
        if not any(entity.x == x and entity.y == y for existing_entity in dungeon.entities):
